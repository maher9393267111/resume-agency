...
const PageHeaders = ({ text, gradient, textColor, paragraph, md, pb, sm }) => {
  return (
      ...
      <div className="container">
        <header className={`md:pt-[210px] ${pb && "md:pb-[120px] pb-[80px]"} pt-[170px]`}>
          <div className={`flex flex-col items-center justify-center ${textColor== "black" ? "text-black" : "text-white"} text-[30px] leading-[42px] text-center`}>
            <h1 className={`max-md:text-[32px] max-md:leading-[42px] max-md:mb-[16px] mb-[25px] ${md && "md:text-[48px] leading-[62px]"} ${sm ? "md:text-[56px] " : "md:text-[64px] "} md:leading-[73px] font-bold`}>{text}</h1>
