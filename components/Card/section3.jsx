...
export default function SectionThree({ locale }) {
  const textsAr = {
    ...
    text2:
      "بطاقة uCard الذكية تغني عن البزنس كارد التقليدية بدون الحاجة للطابعة أو اللمس .. يكفي فقط تقريب البطاقة لأي جوال .. وتواصل مع من حولك ...",
    btn1: "اعرف المزيد",
    btn2: "اطلب الان",
  };
  ...
  const textsEn = {
    ...
    text2:
      "The smart uCard replaces the traditional business card Without the need for a printer or touchscreen...it is enough just to bring the card close to any mobile phone...and communicatewith those around you...",
