		...
		<div className="content resume">
			...
			<div className="row">
				...
				<div className="col col-d-6 col-t-6 col-m-12 border-line-v">
					...
					<div className="resume-items">
						<div className="resume-item border-line-h active">
							...
							<div className="name">Veterinarian</div>
							<div className="company">Peachtree Hills Animal Hospital</div>
							<p>
								Conducted comprehensive physical examinations on various animal
								species.
							</p>
						</div>
						<div className="resume-item border-line-h">
							<div className="date">2021 - 2022</div>
							<div className="name">Veterinary Internship</div>
							<div className="company">Ansley Animal Clinic</div>
							<p>
								Managed day-to-day operations of the veterinary clinic or
								hospital.
							</p>
						</div>
					</div>
				...
				<div className="col col-d-6 col-t-6 col-m-12 border-line-v">
					...
					<div className="resume-items">
						<div className="resume-item border-line-h">
							<div className="date">2013 - 2021</div>
							<div className="name">University of GA College</div>
							<div className="company">Athens, GA</div>
							<p>
								The University of Georgia College of Veterinary Medicine is a
								college within the University of Georgia in Athens, Georgia, &
								is a top 10 ranked veterinary school.
							</p>
						</div>
					</div>
				</div>
