				...
				<div className="row fuct-items">
					...
					<div className="col col-d-3 col-t-3 col-m-6 border-line-v">
						<div className="fuct-item">
							...
							<div className="name">Most Vets are Women</div>
						</div>
					</div>
					{/* fuct item */}
					<div className="col col-d-3 col-t-3 col-m-6 border-line-v">
						<div className="fuct-item">
							...
							<div className="name">62% Americans are animal owners</div>
						</div>
					</div>
					{/* fuct item */}
					<div className="col col-d-3 col-t-3 col-m-6 border-line-v">
						<div className="fuct-item">
							...
							<div className="name">Dogs are top companions</div>
						</div>
					</div>
					{/* fuct item */}
					<div className="col col-d-3 col-t-3 col-m-6 border-line-v">
						<div className="fuct-item">
							...
							<div className="name">$31 billion vet visits annually</div>
						</div>
					</div>
					<div className="clear" />
				</div>
