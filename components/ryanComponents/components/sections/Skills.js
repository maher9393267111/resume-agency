				...
				<div className="row">
					...
					<div className="col col-d-12 col-t-12 col-m-12 border-line-v">
						<div className="skills-list">
							<div className="skill-title border-line-h">
								...
								<div className="name">Veterinary</div>
							</div>
							<ul>
								<li className="border-line-h">
									<div className="name">Anesthesia</div>
									<div className="progress">
										<div className="percentage" style={{ width: "90%" }} />
									</div>
								</li>
								<li className="border-line-h">
									<div className="name">Endoscopy</div>
									<div className="progress">
										<div className="percentage" style={{ width: "65%" }} />
									</div>
								</li>
								...
								<li>
									<div className="name">Dentistry</div>
									<div className="progress">
										<div className="percentage" style={{ width: "85%" }} />
									</div>
								</li>
					...
					<div className="col col-d-6 col-t-6 col-m-12 border-line-v">
						<div className="skills-list list">
							...
							<ul>
								<li>
									<div className="name">Animal Behavior</div>
								</li>
								<li>
									<div className="name">Veterinary Medicine</div>
								</li>
								<li>
									<div className="name">Internal Medicine</div>
								</li>
								<li>
									<div className="name">Client Education</div>
								</li>
								<li>
									<div className="name">Fear Free movement</div>
								</li>
								<li>
									<div className="name">Decision-making</div>
								</li>
								<li>
									<div className="name">Strong analytical skills</div>
								</li>
							</ul>
						</div>
					</div>
