export const en = {
   ...
   bannertitle2:'It allows customers to scan a QR code (quick barcode) to view the menu of a restaurant or café without having to use a paper menu.',
   login :'login',
   register:'register',
   ...
   questionsdesc2:'Search our FAQs for answers to anything you might be wondering',
